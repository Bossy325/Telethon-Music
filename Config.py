...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6468655747:AAFmFELeRiIKeYKfesaJ_kIIu1kMd0PA4sc")
    ...
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "Messi27_bot")
    SUPPORT = os.environ.get("SUPPORT", "-1002015179601") # Your Support
    CHANNEL = os.environ.get("CHANNEL", "-1002015179601") # Your Channel
