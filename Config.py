...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6883259440:AAGZj9LQ7ZjlogPmFjLhSJ3VLyT6xCWD7oU")
    ...
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "@Tens88_bot")
    ...
    ASSISTANT_ID = int(os.environ.get("ASSISTANT_ID", "6696466266")) # telegram I'd not Username
